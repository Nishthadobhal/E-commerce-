...
<div class="d-flex">
<input type="file" id="product_iamge1" name="product_image1" class="form-control" required="required">
<img src="./product_images/<?php echo $product_image1 ?>" alt="" class="product_img">
</div>
    </div>

     <div class="form-outline w-50 m-auto mb-4">
<label for="product_images2" class="form-label">Product Image2</label>
<div class="d-flex">
<input type="file" id="product_iamge2" name="product_image2" class="form-control" required="required">
...
<div class="d-flex">
<input type="file" id="product_iamge3" name="product_image3" class="form-control" required="required">
...
product_description='$product_desc',product_keywords='$product_keywords',product_price='$product_price',date=NOW()"; 
...
// Image2 update only if selected
if($product_image2 != ''){
    move_uploaded_file($temp_image2, "./product_images/$product_image2");
    $update_product .= ", product_image2='$product_image2'";
}

// Image3 update only if selected
if($product_image3 != ''){
    move_uploaded_file($temp_image3, "./product_images/$product_image3");
